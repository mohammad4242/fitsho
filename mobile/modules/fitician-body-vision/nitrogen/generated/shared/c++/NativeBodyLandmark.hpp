...
namespace margelo::nitro::fitician::bodyvision {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeBodyLandmark).
   */
  struct NativeBodyLandmark final {
  public:
  ...
  public:
    NativeBodyLandmark() = default;
    explicit NativeBodyLandmark(double x, double y, double z, double visibility): x(x), y(y), z(z), visibility(visibility) {}

  public:
    friend bool operator==(const NativeBodyLandmark& lhs, const NativeBodyLandmark& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeBodyLandmark <> JS NativeBodyLandmark (object)
  template <>
  struct JSIConverter<margelo::nitro::fitician::bodyvision::NativeBodyLandmark> final {
    static inline margelo::nitro::fitician::bodyvision::NativeBodyLandmark fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::fitician::bodyvision::NativeBodyLandmark(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::fitician::bodyvision::NativeBodyLandmark& arg) {
