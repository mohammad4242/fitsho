...
TEST_PROFILES = [
    {
        ...
        "cautions": [TrainingCaution.KNEE, TrainingCaution.LOWER_BACK],
        "limitations_text": None,
        "priority_muscles": ["abs", "glutes"],
    },
    {
        "num": 2,
        "name": "پریناز صادقی (تست ماه اول ۴ روزه + دمبل خانگی + شانه)",
        "sex": Sex.FEMALE,
    ...
    {
        "num": 3,
        "name": "کامبیز پیروز (تست تضاد اولویت و آسیب در فرکانس ۵ روز)",
        "sex": Sex.MALE,
        ...
        "cautions": [TrainingCaution.SHOULDER, TrainingCaution.WRIST, TrainingCaution.NECK],
        "limitations_text": None,
        "priority_muscles": ["chest", "shoulders", "triceps"],
    },
    {
        "num": 4,
        "name": "مهرداد رفیعی (تست قدرت پیشرفته در فرکانس ۲ روز)",
        "sex": Sex.MALE,
        "birth_date": date(1995, 9, 8),
        "height_cm": 180,
        "weight_kg": 85.0,
        "shoulder_cm": 120.0,
        "waist_cm": 83.0,
    ...
    },
    {
        ...
        "limitations_text": None,
        "priority_muscles": ["quadriceps", "glutes"],
    },
    {
        "num": 6,
        "name": "آناهیتا درخشان (تست ۵ روزه بانوان + اولویت پا و آسیب زانو)",
        "sex": Sex.FEMALE,
        ...
        "limitations_text": None,
        "priority_muscles": ["glutes", "hamstrings", "quadriceps"],
    },
    {
        "num": 7,
        "name": "جهانگیر اسدی (تست آسیب متنی آزاد و غربالگری پزشکی)",
        "sex": Sex.MALE,
        "birth_date": date(1966, 12, 1),
        "height_cm": 173,
        "weight_kg": 86.0,
        "shoulder_cm": 112.0,
        "waist_cm": 96.0,
        ...
        "plan_duration_weeks": 4,
        "training_intensity": TrainingIntensity.LIGHT,
        "cautions": [TrainingCaution.LOWER_BACK, TrainingCaution.SHOULDER],
        "limitations_text": "پارگی تاندون روتاتور کاف شانه راست و سرخوردگی مهره L5-S1",
        "priority_muscles": [],
    },
    {
        "num": 8,
        "name": "هستی خسروی (تست بودجه زمانی فشرده ۳۰ دقیقه در خانه)",
        "sex": Sex.FEMALE,
        ...
        "cautions": [],
        "limitations_text": None,
        "priority_muscles": ["glutes", "shoulders"],
    },
    {
        "num": 9,
        "name": "پرهام توکلی (تست تمرکز بر عضلات کوچک بازو و ساعد)",
        "sex": Sex.MALE,
        "birth_date": date(1999, 10, 22),
        "height_cm": 184,
        "weight_kg": 79.0,
        "shoulder_cm": 119.0,
        "waist_cm": 80.0,
        ...
        "cautions": [],
        "limitations_text": None,
        "priority_muscles": ["biceps", "triceps", "forearms"],
    },
    {
        "num": 10,
        "name": "سمیرا یزدانی (تست وزن بدن خانه ۳ روزه با احتیاط شانه و گردن)",
        "sex": Sex.FEMALE,
        ...
        "plan_duration_weeks": 6,
        "training_intensity": TrainingIntensity.MODERATE,
        "cautions": [TrainingCaution.SHOULDER, TrainingCaution.NECK],
        "limitations_text": None,
        "priority_muscles": ["glutes", "abs"],
    },
]
    ...
    if success and plan:
        ...
        if err_code == "PROGRAM_REJECTED_SAFETY_STATUS":
            ...
            if p["num"] == 5:
                ...
                err_desc = (
                    "تضاد حجم هفتگی و احتیاط مفصلی: کاربر برنامه ۵ روزه با اولویت سرشانه و همزمان احتیاط شانه درخواست کرده است. "
                    "قیدهای سقف حجم هفتگی و مدت زمان جلسه به دلیل حذف حرکات فشاری بالای سر ارضا نشده و موتور به درستی چیدمان ناامن را ریجکت کرده است."
                )
            else:
...
<body>
  ...
  <section class="summary-box">
    <div class="summary-title">خلاصه نتایج آزمون جامع موتور (۱۰ پروفایل)</div>
    <div class="stats-grid">
      ...
      <div class="stat-col">
        ...
        <div class="stat-lbl">رد ایمنی یا قیدهای غیرقابل ارضا</div>
      </div>
    </div>

    <div style="font-weight: bold; font-size: 8.5pt; color: #1a202c; margin-top: 2mm;">تحلیل مهندسی رفتار و خروجی‌های موتور تمرینی:</div>
    <ul class="analysis-list">
      <li><strong>مدیریت هوشمند احتیاط‌های ساختاریافته (Structured Cautions):</strong> کاربران با احتیاط‌های زانو (کاربر ۱)، کمر (کاربر ۴)، شانه (کاربر ۷) و ستون فقرات/گردن (کاربر ۸) برنامه‌های تمرینی منطبق با ایمنی دریافت کردند که در آن‌ها حرکات پرریسک محوری یا آسیب‌رسان فیلتر و جایگزین شدند.</li>
      <li><strong>تشخیص و کنترل قیدهای تجهیزات در خانه (Equipment Constraint Gate):</strong> در کاربر شماره ۵ (خانه، فقط وزن بدن + احتیاط مچ دست)، موتور به دلیل کمبود حرکات ایمن بدون فشار بر مچ در سطح وزن بدن برای یک تقسیم‌بندی ۳ روزه، از تولید برنامه ناقص خودداری کرده و خطای <code>UNSATISFIED_CONSTRAINT</code> صادر نمود.</li>
      <li><strong>پوشش تنوع تجربی و اهداف:</strong> ۹ پروفایل در سطوح ماه اول تا پیشرفته، اهداف هایپرتروفی، چربی‌سوزی، ریکامپ، افزایش وزن و قدرت، با فرکانس‌های ۲ تا ۵ روز به طور کامل تولید و بهینه‌سازی شدند.</li>
      <li><strong>اصالت کاتالوگ و اصطلاحات:</strong> کلیه حرکات با اسامی دقیق فارسی ثبت‌شده در پایگاه‌داده و پارامترهای ست، تکرار، RIR، استراحت و قواعد پیشرفت درج شده‌اند.</li>
    </ul>
  </section>
