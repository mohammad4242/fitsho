...
FA_TRANSLATIONS = {
    ...
    "gym": "باشگاه (Gym)",
    "home": "منزل (Home)",
    "bodyweight_only": "وزن بدن (Bodyweight)",
    "dumbbells_available": "دمبل (Dumbbells)",
    "resistance_bands_available": "کش (Resistance band)",
    "dumbbells_and_resistance_bands_available": "دمبل + کش (Dumbbells + resistance band)",
    "chest": "سینه (Chest)",
...
def define_20_diverse_profiles() -> list[ProfileSpec]:
    return [
        ...
        ProfileSpec(
            ...
            training_location=TrainingLocation.HOME,
            home_training_setup=HomeTrainingSetup.RESISTANCE_BANDS_AVAILABLE,
            priority_muscle=None,
            training_cautions=[],
            plan_duration_weeks=4,
            sleep_quality=RecoveryRating.AVERAGE,
        ...
        ProfileSpec(
            ...
            session_duration_minutes=60,
            training_location=TrainingLocation.HOME,
            home_training_setup=HomeTrainingSetup.DUMBBELLS_AND_RESISTANCE_BANDS_AVAILABLE,
            priority_muscle=MuscleGroup.GLUTES,
            training_cautions=[],
            plan_duration_weeks=4,
            sleep_quality=RecoveryRating.GOOD,
