...
def full_catalog() -> list[ExerciseCandidate]:
    ...
    return [
        ...
        exercise("incline-push-up", MovementPattern.HORIZONTAL_PUSH, MuscleGroup.CHEST),
        exercise("decline-push-up", MovementPattern.HORIZONTAL_PUSH, MuscleGroup.CHEST),
        exercise(
        ...
        exercise("pike-push-up", MovementPattern.VERTICAL_PUSH, MuscleGroup.SHOULDERS),
        exercise(
            "rear-delt-fly",
            MovementPattern.HORIZONTAL_PULL,
            MuscleGroup.SHOULDERS,
        ...
        exercise("isometric-shrug", MovementPattern.SHRUG, MuscleGroup.TRAPS),
        exercise("single-leg-calf-raise", MovementPattern.CALF_RAISE, MuscleGroup.CALVES),
        exercise("glute-bridge", MovementPattern.HIP_EXTENSION, MuscleGroup.GLUTES),
        exercise("hamstring-walkout", MovementPattern.KNEE_FLEXION, MuscleGroup.HAMSTRINGS),
        exercise(
            "side-plank",
