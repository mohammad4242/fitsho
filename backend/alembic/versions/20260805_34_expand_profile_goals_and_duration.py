...
_GOALS = "'lose_weight', 'gain_weight', 'fat_loss', 'build_muscle', 'body_recomposition', 'improve_fitness', 'maintain_weight'"
...
def upgrade() -> None:
    ...
    op.drop_constraint("ck_training_program_templates_fitness_goal_values", "training_program_templates")
    op.create_check_constraint(
