...
_DEFINITIONS: tuple[CanonicalTemplateDefinition, ...] = (
    ...
    _definition(
        ...
        "Use as a neutral three-day upper/lower option and keep direct arm work after major upper-body muscles.",
        "این گزینه یک ساختار خنثی سه‌روزه بالاتنه/پایین‌تنه است و کار مستقیم بازو باید بعد از عضلات اصلی بالاتنه بیاید.",
    ...
    _definition(
        ...
        "The final two days are meaningful second exposures, not permission for excessive per-session volume.",
        "دو روز پایانی مواجهه دوم معنادار هستند و مجوز حجم بیش‌ازحد در هر جلسه نیستند.",
        "Use compound-before-isolation ordering on every PPL and second-exposure day, with no redundant extra exercise.",
        "در هر روز PPL و مواجهه دوم، ترتیب ترکیبی پیش از تک‌مفصلی را حفظ کن و حرکت اضافی تکراری نگذار.",
...
APPROVED_STRUCTURE_SEEDS = (
    ...
    TrainingProgramStructureSeed(
        ...
        None,
        "Approved Iranian five-day upper/lower split.",
        "تقسیم ایرانی پنج‌روزه بالاتنه / پایین‌تنه تأییدشده.",
        (
            ("upper", "Chest + Triceps", "سینه + پشت بازو"),
