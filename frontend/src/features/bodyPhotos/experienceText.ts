...
const experienceTranslationKeys: Record<string, string> = {
  ...
  "body_analysis.indicators.body_proportion": "bodyAnalysis.indicators.bodyProportion.message",
  ...
  "body_analysis.indicators.current_development_focus": "bodyAnalysis.indicators.currentDevelopmentFocus.message",
