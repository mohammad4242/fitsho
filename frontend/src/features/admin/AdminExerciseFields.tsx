...
const sectionByField: Partial<Record<keyof AdminExerciseForm, string>> = {
  ...
  body_position: "programming",
  stability_demand: "programming",
  skill_demand: "programming",
  impact_level: "programming",
  axial_loading_level: "programming",
  fatigue_cost: "programming",
  setup_cost: "programming",
  laterality: "programming",
  substitution_group: "programming",
  range_of_motion_profile: "programming",
  labels: "programming",
