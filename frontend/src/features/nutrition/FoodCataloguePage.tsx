...
function priceUnit(unit: string, language: "fa" | "en") { const labels: Record<string, [string, string]> = { IRR_PER_KG: ["ریال برای هر کیلوگرم", "IRR per kilogram"], IRR_PER_LITER: ["ریال برای هر لیتر", "IRR per litre"], IRR_PER_UNIT: ["ریال برای هر عدد", "IRR per unit"] }; return labels[unit]?.[language === "fa" ? 0 : 1] ?? unit; }
