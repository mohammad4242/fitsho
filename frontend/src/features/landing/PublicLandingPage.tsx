...
const copy = {
  fa: {
    ...
    social: { label: "شبکه‌های اجتماعی", title: "با فیتشو همراه بمان", soon: "لینک به‌زودی اضافه می‌شود" },
  },
  en: {
    ...
    social: { label: "Social media", title: "Stay close to Fitsho", soon: "Link coming soon" },
  },
} as const;
